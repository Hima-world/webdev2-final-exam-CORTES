    ...
    <div class="relative flex items-top justify-center min-h-screen bg-white-100 dark:bg-white-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="max-w-6xl content">
            <div class="bye">
                ...
                <p style="color:#FFFFFF;">Your request has been recorded. </p>
                <br>

                <p style="color:#bee3db;">Submit another request <br><a href="/bible-study-request-form">Request Form</a>
                <p>
                <p style="color:#bee3db;">Check request lists on <br> <a href="/bible-study-requests">Table Lists</a><br>

            </div>
            <br> <br>
            <p style="color:#000000;">Back to <br> <a href="/">Homepage</a><br>
        </div>
